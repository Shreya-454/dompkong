...
import footg1 from "../assets/images/foot-gradient.png";
    ...
    <div>
      {id === open ? (
        <div className="relative inline-block">
          ...
          <div className="w-[18px]  h-[2px] mx-auto  rounded-sm bg-[#FDDA60] shadow-[0_0_2px1px#FDDA60] "></div>
        </div>
      ) : (
        <div className="relative inline-block">
          <div className="w-[2px] h-[17px] mx-auto  opacity-100 duration-300 rounded-sm bg-[#FDDA60] shadow-[0_0_2px1px#FDDA60] absolute left-[8px] top-[-7px]"></div>
          <div className="w-[18px] h-[2px] mx-auto  rounded-sm bg-[#FDDA60] shadow-[0_0_2px1px#FDDA60] "></div>
        </div>
      )}
    </div>
  ...
  return (
    <div className="md:pt-36 pt-10 relative">
      ...
      <div className=" max-w-[1140px] px-3 mx-auto">
        <p className="text-center text-[45px] md:text-[64px] text-white font-AzoSans font-normal leading-[108%]">
          FAQs
        </p>
        <div className="mt-[55px] max-w-[896px] mx-auto">
          <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
            <AccordionHeader
              onClick={() => handleOpen(1)}
              className="text-white font-mont text-base md:text-[22px]  font-bold leading-[23px] hover:text-white border-0 flex justify-between"
            >
              Arcu faucibus diam feugiat magna etiam.
            </AccordionHeader>
            <AccordionBody className=" text-white font-mont text-[14px] md:text-base font-normal leading-[25px] pt-[9px]">
          ...
          <div className="w-full border-[#FDDA60] border-t-[1px]   shadow-[0_0_8px_5px_#3D3421]  mb-[9px] "></div>
          <Accordion open={open === 2} icon={<Icon id={2} open={open} />}>
            <AccordionHeader
              onClick={() => handleOpen(2)}
              className="text-white font-mont text-base md:text-[22px]  font-bold leading-[23px] hover:text-white border-0 flex items-center justify-between"
            >
          ...
          <Accordion open={open === 4} icon={<Icon id={4} open={open} />}>
            <AccordionHeader
              ...
              className="text-white font-mont text-base md:text-[22px]  font-bold leading-[23px] hover:text-white border-0 flex justify-between items-center"
            >
        ...
        <div className="flex justify-center md:pt-[92px] pt-10 flex-col items-center">
          <img src={logo2} alt="logo" data-aos="zoom-in" data-aos-duration="4000" data-aos-easing="linear" />
          <div className="flex gap-6 mt-7">
            <a href="https://twitter.com/" target="blank" className="hover:scale-125 duration-300" >
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
            ...
            <a href="https://opensea.io/" target="blank"  className="hover:scale-125 duration-300">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <a href="https://discord.com/" target="blank" className="hover:scale-125 duration-300">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
            ...
            <a href="https://web.telegram.org/a/" target="blank" className="hover:scale-125 duration-300">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"

      ...
      <>
        ...
        >
          <path
            ...
            className="group-hover:stroke-black duration-500"
          />
          <path
...
const Sec3 = () => {
  const cards = data.map((data) => (
    <div key={data.id} className="lg:w-1/3 md:w-1/2 w-full px-3 mb-10 lg:mb-0 flex justify-center">
      <div className="w-full rounded-2xl bg-white bg-opacity-10 backdrop-blur-[15.5px] px-5 py-6 group hover:bg-[#FDDA60] hover:shadow-[0px_14px_56px_0px_#FDDA6080] border border-solid border-[#FFFFFF33] hover:border-[#FFFFFF] relative overflow-hidden duration-500 max-w-[369px]" data-aos="fade-up" data-aos-duration="1700"      data-aos-easing="linear">
        <div className="w-[91px] h-[91px] bg-white blur-[76px] absolute right-0 top-0 group-hover:hidden"></div>
        <div className="w-[91px] h-[91px] bg-white blur-[94px] absolute left-0 bottom-0 group-hover:hidden"></div>
        <div className="flex justify-center pb-4">
          <span>{data.icon}</span>
        </div>
        <h3 className="text-center text-white font-mont text-xl md:text-2xl font-bold leading-[26.1px] max-w-[330px] mx-auto mb-[14px] group-hover:text-black duration-500">
          {data.title}
        </h3>
        <p className="text-white text-center font-mont text-[14px] md:text-base leading-[25.6px] group-hover:text-black font-normal duration-500">
          {data.para}
        </p>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#0A0A0A] lg:pt-4 lg:pb-32 pb-5 pt-10">
      <div className="max-w-[1140px] mx-auto px-3">
        <h2 className="text-white font-AzoSans text-center text-[45px] md:text-[64px] leading-[69.6px] mb-14">
          Utilities
        </h2>

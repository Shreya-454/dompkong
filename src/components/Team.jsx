...
const info = [
  {
    ...
    post: "Carter Septimus",
    img: img1,
    user: "@Jaylon Schleifer",
    dis: "Nearly two decades in Business",
    p1:
      "Faucibus risus id libero interdum in nisl nibh risus molestie. Gravida purus mauris nulla duis est eleifend. Suspendisse eu iaculis odio sit. Hac orci massa habitasse congue nulla tristique. ",
    p2:
  ...
  },
  {
    ...
    post: "Jakob Ekstrom Bothman",
    img: img2,
    user: "@Talan Passaquindici Arcand",
    dis: "Invester  & International Top Model",
    p1:
      "Neque hendrerit lectus neque molestie facilisis. Faucibus arcu eget facilisis nisl id ultricies. Aliquet eget scelerisque posuere habitant mauris quis ridiculus rutrum consectetur. ",
    p2:
  ...
  {
    name: "Alfonso Franci",
    post: "Alfonso Dokidis",
    img: img3,
    user: "@Alfonso Franci",
    dis: "Nearly two decades in Business",
    p1:
      "A ut sagittis, purus sit integer suspendisse lacus quam auctor. Interdum venenatis, sed ligula purus erat. A hac faucibus blandit euismod molestie amet nibh scelerisque. ",
    p2:
    ...
    <div key={info.id}>
      ...
      <div   className="flex flex-wrap flex-row -mx-3">
        <div className="md:w-1/2 w-full px-3 flex flex-col items-center md:block mb-5 md:mb-0">
          ...
          <div className="max-w-[230px] rounded-[20px] ">
            <img
              src={info.img}
              alt="img"
              className="  rounded-[20px] border-[3px] border-solid border-[#FDDA60] shadow-[0px_0px_20px_4px_#FDDA60]" data-aos="fade-up-right" data-aos-duration="4000"
                   data-aos-easing="linear"
            />
          </div>
        </div>
        <div className="md:w-1/2 w-full px-3 flex flex-col items-center md:block">
          <h4 className="text-white md:text-2xl text-xl font-mont font-semibold leading-[26.1px] mb-3 text-center md:text-start ">
            {info.user}
          </h4>
          <h5 className="text-white font-mont md:text-xl text-lg leading-[21.75px] mb-8 text-center md:text-start">
            {info.dis}
          </h5>
          <p className="text-white font-mont md:text-base text-[14px] leading-[25.6px] mb-[10px] text-center md:text-start">
            {info.p1}
          </p>
          <p className="text-white font-mont md:text-base text-[14px] leading-[25.6px] mb-8 text-center md:text-start">
            {info.p2}
          </p>
            ...
            <span className="group">
              <a href="https://www.instagram.com/">
                <svg
                  ...
                  className="group-hover:drop-shadow-[0px_0px_4px_#FDDA60]"
                >
                  <path
